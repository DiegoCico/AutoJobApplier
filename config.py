...
add_education = 'Master'  # Other, Highschool, Associate, Bachelor, Master, Doctorate -- education level
add_leadershipdevelopment = '5'  # years
add_salary = '10k'  # your salary expectation
